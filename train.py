...
def main():
    ...
    seq2seq = Seq2Seq(encoder, decoder, encoder_optimizer, decoder_optimizer).to(device)
    ...
    for iter in range(1, n_iters+1):
        ...
        loss = seq2seq(input_tensor, target_tensor, criterion)
    ...
    _, pairs, grouped = prepareData("data/train.txt")
    evaluateRandomly(seq2seq)
